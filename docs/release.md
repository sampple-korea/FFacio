...
- RGB webcam liveness uses passive MiniFASNet anti-spoofing plus randomized gaze prompts and a short stable-pose hold to reduce simple photo/screen attacks, but high-quality replay/video attacks still require depth/IR hardware or a second factor before real door control.
